...
def process_start(message):
    ...
    msg = bot.send_message(message.chat.id, text = 'To use this bot, please digit a Pokemon Unite character as the example bellow.\n\n Try to spell it correctly.', reply_markup = keyboard )
